...
import marketData from '@/assets/chart.jpg';
import DemoVideo1 from '@/assets/demo-1.mp4';
import DemoVideo2 from '@/assets/demo-2.mp4';
	...
	return (
		<section id='market' className='section-padding bg-muted/30'>
			<div className='container-max'>
				<div className='text-center mb-16'>
					...
					<p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
						The convergence of regulatory pressure, consumer demand,
						and corporate sustainability goals creates an
						unprecedented opportunity for bio-based ingredients.
					</p>
				</div>
          ...
          /> */}
				...
				<div className='mb-16 flex flex-col md:flex-row w-full h-auto gap-'>
					<video
						className='w-full md:w-[50%] h-[750px] object-cover rounded-tl-md rounded-bl-md'
						autoPlay
						loop
						muted
						playsInline
					>
						<source src={DemoVideo1} />
					</video>

					<video
						className='w-full md:w-[50%] h-[750px] object-cover rounded-tr-md rounded-br-md'
						autoPlay
						loop
						muted
						playsInline
					>
						<source src={DemoVideo2} />
					</video>
				</div>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16'>
					<Card className='card-eco text-center'>
						...
						<p className='text-muted-foreground mb-2'>
							Surfactant Market (2023)
						</p>
						<p className='text-sm text-success font-medium'>
							Growing to $21B by 2030
						</p>
					</Card>
					...
					<Card className='card-eco text-center'>
						...
						<p className='text-muted-foreground mb-2'>
							Glycolic Acid Market (2023)
						</p>
						<p className='text-sm text-success font-medium'>
							Growing to $760M by 2030
						</p>
					</Card>
				...
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
					<Card className='card-eco'>
						...
						<div className='space-y-4'>
							...
							<div className='flex items-center justify-between'>
								<span>
									Willingness to pay premium for eco-products
								</span>
								<div className='flex items-center'>
									<div className='w-24 h-2 bg-muted rounded-full mr-2'>
						...
						<div className='space-y-6'>
							<div>
								...
								<p className='text-muted-foreground text-sm'>
									Increasing bans on toxic ingredients and
									stricter environmental regulations across
									markets.
								</p>
							</div>
							<div>
								...
								<p className='text-muted-foreground text-sm'>
									Major brands like L'Oréal committing to 100%
									eco-designed formulas by 2030.
								</p>
							</div>
							<div>
								<h4 className='font-semibold mb-2'>
								...
								<p className='text-muted-foreground text-sm'>
									Investor pressure for environmental, social,
							...
							<div>
								...
								<p className='text-muted-foreground text-sm'>
									Reducing dependence on volatile
									petrochemical markets with sustainable
									alternatives.
								</p>
							</div>
						</div>
