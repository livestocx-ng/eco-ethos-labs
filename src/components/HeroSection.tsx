      ...
      <div className="relative z-10 container-max text-center text-white">
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <p className="text-xl lg:text-2xl mb-8 text-white/90 max-w-3xl mx-auto">
            Next-generation bio-based surfactants and glycolic acid with 50-70% lower carbon footprint, 
            enabling a sustainable future for the $530B beauty industry.
          </p>

          {/* Key Stats */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-green-300 mb-2">50-70%</div>
              <div className="text-white/80">Lower Carbon Footprint</div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-green-300 mb-2">$14B</div>
              <div className="text-white/80">Surfactant Market</div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-green-300 mb-2">60%</div>
              <div className="text-white/80">Consumer Eco-Demand</div>
            </div>
          </div>
